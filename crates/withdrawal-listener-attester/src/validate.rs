...
/// The details a PUBLIC discovered note carries: its evidence-attachment payload felts and its
...
impl DiscoveredDetails {
    /// From the raw evidence-attachment payload felts and an already-modelled sender.
