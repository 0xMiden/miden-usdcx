...
/// payload is not a structurally valid DepositIntent, or it exceeds the 1024-felt `NoteStorage`
/// bound, or `faucet_id` is not a public network account. That crate's `NoteError` (and the
