...
pub use builder::{
    XReserveStablecoinBuilder, XReserveStablecoinBuilderError, BURN_POLICY_PROC_PATH,
    DOMAIN_CONFIG_SLOT_LABEL, DOM_MANAGER_ROLE, DOM_PAUSER_ROLE, IDENTIFIER_CONFIG_SLOT_LABEL,
    MINT_DENY_GUARD_PROC_PATH, MIN_BURN_SIZE_SLOT_LABEL, REQUIRED_XRESERVE_SLOT_LABELS,
