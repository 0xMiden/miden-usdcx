...
fn main() {
    ...
    let mut b32: Vec<Value> = b32_inputs
        ...
        .map(|(id, b, what)| {
            json!({
                ...
                "cite": "generated deterministically by gen_vectors @ protocol v0.17.0-rc.6",
                "derivation": format!(
                    "{what}; key = Hasher::hash_elements(bytes_to_packed_u32_elements(b)) @ protocol v0.17.0-rc.6 (gen_vectors)"
                ),
            })
        })
        .collect();
    ...
    b32.push(json!({
        ...
        "cite": "generated deterministically by gen_vectors @ protocol v0.17.0-rc.6",
        "derivation": "first 8-byte LE limb = u64::MAX >= p, so the fallible native path must reject while Option B hashes; key computed @ v0.17.0-rc.6",
    }));
    ...
    let amt = vec![
        ...
        amt_reject(
            ...
            "AmountOverCap",
            "generated deterministically by gen_vectors @ protocol v0.17.0-rc.6",
    ...
    for (n, id) in ids.iter().enumerate() {
        ...
        aid.push(json!({
            ...
            "derivation": format!(
                "AccountIdBuilder::new().build_with_seed([{}; 32]) @ v0.17.0-rc.6; R-B layout: bytes[0..16]=0, [16..24]=prefix u64 BE, [24..32]=suffix u64 BE",
                n + 1
            ),
        }));
    }
    ...
    // breaks canonicity).
    {
        ...
        aid.push(json!({
            ...
            "cite": "generated deterministically by gen_vectors @ protocol v0.17.0-rc.6",
            "derivation": "R-B layout, zero pad; prefix=suffix=7 (in-field) rejected by AccountId::try_from_elements @ v0.17.0-rc.6",
        }));
    }
