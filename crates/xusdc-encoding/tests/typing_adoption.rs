...
//!
//! It locks: (1) the faucet-owned admin note factory has a `bon` builder + a dedicated
//! note-storage type, and the builder produces a note byte-identical to the retained `create`
//! convenience; (2) the
...
//! `AccountComponent`. A missing builder / storage type / export, or a builder that drifts from
//! `create`, fails here.
...
// The faucet-owned admin note factory: bon builder + dedicated storage type, byte-identical to
// `create`.
// ================================================================================================
...
// G-RUST — the admin note-storage type keeps its fields PRIVATE, exposing read-only accessors.
// ================================================================================================
