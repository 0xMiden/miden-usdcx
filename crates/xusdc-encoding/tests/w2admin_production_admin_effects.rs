...
/// The callable surface is the ratified sixty-five procedures, and the swap is visible in it: the
/// four standard manager procedures are present.
#[tokio::test]
async fn the_callable_surface_is_the_ratified_sixty_five_procedures() -> Result<()> {
