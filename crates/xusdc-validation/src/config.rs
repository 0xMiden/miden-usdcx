...
use xusdc_encoding::xreserve::encoding::{bytes32_to_storage_map_key, LocalChainAddress};
...
pub struct DomainParams {
    ...
    pub xreserve_contract: LocalChainAddress,
...
impl DomainParams {
    ...
    pub fn lnv1() -> Self {
        Self {
            domain: 1313,
            source_domain: 7,
            xreserve_contract: LocalChainAddress::new([0xC1; 32]),
    ...
    pub fn lnv1_reinit_attempt() -> Self {
        Self {
            domain: 9999,
            source_domain: 42,
            xreserve_contract: LocalChainAddress::new([0xEE; 32]),
