...
pub(crate) fn mint_note_for(
    ...
    let note = XUsdcMintNote::create(sender, faucet_id, MINT_DOMAIN, &payload, &attestation, rng)
...
fn mint_note_forged_sig(
    ...
    XUsdcMintNote::create(sender, faucet_id, MINT_DOMAIN, &payload, &forged, rng)
